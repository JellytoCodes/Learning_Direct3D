...
public :
	...
	const Keyframe& GetKeyframe(int32 index) { return _keyframes[index]; }
	int32 GetKeyframeCount() { return static_cast<int32>(_keyframes.size()); }
	void AddKeyframe(const Keyframe& keyframe) { _keyframes.push_back(keyframe); }
